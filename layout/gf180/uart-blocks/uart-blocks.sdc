...
set_input_delay 1.2000 -clock [get_clocks {clk}] -add_delay [get_ports {s_axis_tdata[0]}]
set_input_delay 1.2000 -clock [get_clocks {clk}] -add_delay [get_ports {s_axis_tdata[1]}]
set_input_delay 1.2000 -clock [get_clocks {clk}] -add_delay [get_ports {s_axis_tdata[2]}]
set_input_delay 1.2000 -clock [get_clocks {clk}] -add_delay [get_ports {s_axis_tdata[3]}]
set_input_delay 1.2000 -clock [get_clocks {clk}] -add_delay [get_ports {s_axis_tdata[4]}]
set_input_delay 1.2000 -clock [get_clocks {clk}] -add_delay [get_ports {s_axis_tdata[5]}]
set_input_delay 1.2000 -clock [get_clocks {clk}] -add_delay [get_ports {s_axis_tdata[6]}]
set_input_delay 1.2000 -clock [get_clocks {clk}] -add_delay [get_ports {s_axis_tdata[7]}]
set_input_delay 1.2000 -clock [get_clocks {clk}] -add_delay [get_ports {s_axis_tvalid}]
...
set_output_delay 1.2000 -clock [get_clocks {clk}] -add_delay [get_ports {rx_busy}]
set_output_delay 1.2000 -clock [get_clocks {clk}] -add_delay [get_ports {rx_frame_error}]
set_output_delay 1.2000 -clock [get_clocks {clk}] -add_delay [get_ports {rx_overrun_error}]
set_output_delay 1.2000 -clock [get_clocks {clk}] -add_delay [get_ports {s_axis_tready}]
set_output_delay 1.2000 -clock [get_clocks {clk}] -add_delay [get_ports {tx_busy}]
set_output_delay 1.2000 -clock [get_clocks {clk}] -add_delay [get_ports {txd}]
###############################################################################
# Environment
###############################################################################
###############################################################################
