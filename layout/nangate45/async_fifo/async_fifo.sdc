...
set_output_delay 0.2000 -clock [get_clocks {core_clock}] -add_delay [get_ports {pointer_wraparound_flag}]
...
set_output_delay 0.2000 -clock [get_clocks {core_clock}] -add_delay [get_ports {sync_error_flag}]
