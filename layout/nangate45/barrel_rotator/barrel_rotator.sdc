...
set_input_delay 0.2000 -clock [get_clocks {core_clock}] -add_delay [get_ports {rotate_amount[0]}]
set_input_delay 0.2000 -clock [get_clocks {core_clock}] -add_delay [get_ports {rotate_amount[1]}]
set_input_delay 0.2000 -clock [get_clocks {core_clock}] -add_delay [get_ports {rotate_amount[2]}]
