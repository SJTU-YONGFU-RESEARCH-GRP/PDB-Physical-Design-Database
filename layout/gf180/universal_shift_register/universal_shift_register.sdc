...
set_input_delay 0.2000 -clock [get_clocks {core_clock}] -add_delay [get_ports {direction[0]}]
set_input_delay 0.2000 -clock [get_clocks {core_clock}] -add_delay [get_ports {direction[1]}]
...
set_input_delay 0.2000 -clock [get_clocks {core_clock}] -add_delay [get_ports {serial_in_left}]
set_input_delay 0.2000 -clock [get_clocks {core_clock}] -add_delay [get_ports {serial_in_right}]
