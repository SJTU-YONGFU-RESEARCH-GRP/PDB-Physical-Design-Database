...
###############################################################################
current_design smart_fifo
###############################################################################
# Timing Constraints
###############################################################################
create_clock -name core_clock -period 1.0000 [get_ports {clk}]
set_propagated_clock [get_clocks {core_clock}]
set_input_delay 0.2000 -clock [get_clocks {core_clock}] -add_delay [get_ports {clear_errors}]
...
set_output_delay 0.2000 -clock [get_clocks {core_clock}] -add_delay [get_ports {error_detected}]
set_output_delay 0.2000 -clock [get_clocks {core_clock}] -add_delay [get_ports {full}]
set_output_delay 0.2000 -clock [get_clocks {core_clock}] -add_delay [get_ports {overflow_detected}]
...
set_output_delay 0.2000 -clock [get_clocks {core_clock}] -add_delay [get_ports {underflow_detected}]
