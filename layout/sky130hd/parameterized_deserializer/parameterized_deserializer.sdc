...
###############################################################################
current_design parameterized_deserializer
###############################################################################
# Timing Constraints
###############################################################################
...
set_output_delay 0.2000 -clock [get_clocks {core_clock}] -add_delay [get_ports {rx_busy}]
set_output_delay 0.2000 -clock [get_clocks {core_clock}] -add_delay [get_ports {rx_done}]
set_output_delay 0.2000 -clock [get_clocks {core_clock}] -add_delay [get_ports {sync_detected}]
###############################################################################
# Environment
###############################################################################
###############################################################################
